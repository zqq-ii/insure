...
from Manual_Testing.common.communal import RandomStr, Execution_Time, Time
...
class Payment_refund:
    ...
    def Payment_refund(self):
        ...
        body = {
            "Data": {
                "AgencyPolicyRef": "GeIZe9e9UIC6c4Va",  # 第三方渠道公司保单号码或者第三方渠道公司订单号码;[太平门店险传大订单号]
                "PolicyRef": "ET202300000160945045",  # 保单号;[太平门店险传大投保单号,可不传]
