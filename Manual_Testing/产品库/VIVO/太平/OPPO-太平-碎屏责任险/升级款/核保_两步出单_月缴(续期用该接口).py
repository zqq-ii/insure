        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "PlanCode": "TP2022072802",  # 计划代码   (升级款:TP2022031802取消期数和日期校验规则,不支持倒签)
                    "IssueDate": "20231230115122",  # 出单时间
                    "EffectiveDate": "20231230115122",  # 生效时间
                    "ExpireDate": "20240130115121",  # 失效时间
                    "GroupSize": "1",  # 被保人个数
                    "Currency": "CNY",  # 币别
                    "PaymentType": "1",  # 缴费方式：1-年缴2-月缴3-趸缴4-免缴
                    "TotalPremium": "3.8",  # 总保费
