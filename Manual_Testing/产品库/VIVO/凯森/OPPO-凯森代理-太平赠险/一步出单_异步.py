...
from Manual_Testing.common.RandomNumber import RandomStr, Execution_Time,Tomorrow,SeveralMonths,Time
        ...
        body = {
            "Data": {
                "Policy": {
                    ...
                    "PlanCode": "KS2022042001",  # 计划代码
                    "IssueDate": Time(),  # 出单时间
                    "EffectiveDate": Tomorrow(),  # 生效时间
                    "ExpireDate": SeveralMonths(month=3),  # 失效时间
                    "GroupSize": "1",  # 被保人个数
                    "TotalPremium": "0",  # 总保费
                    "Currency": "CNY",  # 币别
