...
from Manual_Testing.common.RandomNumber import RandomStr, Execution_Time,Tomorrow,SeveralDays,Time
        ...
        body = {
            "Data": {
                ...
                "PolicyHolder": {
                    ...
                    "PolicyHolderName": "孙彦军",  # 用户姓名（企业、公司名称）
                    "PolicyHolderSex": None,  # 性别（0女，1男，2其它）
                    "PHIdType": "01",
                    # 证件类型01身份证,02户口簿,03护照,04军官证,05驾驶执照,06港澳返乡证,07台胞证,08出生证,09统一社会信用代码,10纳税人识别号,11其他)
                    "PHIdNumber": "530113199801079241",  # 证件号
                    "PHTelephone": "15086228547",  # 手机号（投保人类型为2-企业时非必填）   (注:本产品,会校验手机号,是否投过保)
