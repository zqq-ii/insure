                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "InsuredName": "雷九",  # 用户姓名/企业名
                        "Gender": "0",  # 性别（0女，1男，2其它）
                        "InsuredType": "D1",  # 被保险人类型(参考附录 证件类型（个人）) 特殊说明下必传
                        "Type": "1",  # 被保人类型1-个人2-企业或者机构（默认个人）
                        "IdType": "01",  # 证件类型(参考附录 证件类型（个人）)投保类型为2不传
                        "IdNumber": "310230200003173926",  # 证件号/企业编号
                        "BirthDate": "20000317000000",  # 出生日期 投保类型为2非必传
