        ...
        body = {
            "Data": {
                ...
                "PolicyHolder": {  # 投保人信息
                    ...
                    "PHIdNumber": "21072719840823354X",  # 证件号/企业编号
                    "PHBirthDate": "19840823000000",  # 出生日期 投保类型为2不传
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "21072719840823354X",  # 证件号/企业编号
                        "BirthDate": "19840823000000",  # 出生日期 投保类型为2非必传
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "300.50",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "300.50"  # 分期保费
                    }
                ]
            },
