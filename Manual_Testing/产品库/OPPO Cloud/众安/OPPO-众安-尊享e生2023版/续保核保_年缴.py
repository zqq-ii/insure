...
class Renew_insurance:
    ...
    def Renew_insurance(self):
        ...
        body = {
            "Data": {
                "Policy": {
                    "OriginalPolicyRef": "IH1100014625869122",  # 原保单号
                ...
                "InsuredList": [
                    {
                        ...
                        "IdNumber": "542123199801070235",  # 证件号
