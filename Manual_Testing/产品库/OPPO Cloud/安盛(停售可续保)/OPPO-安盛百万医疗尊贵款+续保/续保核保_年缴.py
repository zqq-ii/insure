...
class Renew_insurance:
    ...
    def Renew_insurance(self):
        ...
        body = {
            "Data": {
                "Policy": {
                    "OriginalPolicyRef": "21010000H27250000003",  # 原保单号
                    "AgencyPolicyRef": co.RandomStr().create(),  # 第三方订单号
                    "PlanCode": "AS202412270101",  # 计划代码 续保计划码(年:AS202302160201、月:AS202302160202)
                    "IssueDate": co.Time(),  # 出单时间
                    "EffectiveDate": "20250104000000",
                    "ExpireDate": "20260103235959",# 失效时间
                    "GroupSize": "1",  # 被保人个数
                    "Currency": "CNY",  # 币种
                    "PaymentType": "1",  # 缴费方式：1-年缴2-月缴3-趸缴4-免缴
                    "TotalPremium": "404.70",  # 总保费
                ...
                "InsuredList": [
                    {
                        ...
                        "IdNumber": "230621199801075247",  # 证件号
