...
class Renew_insurance:
    ...
    def Renew_insurance(self):
        ...
        body = {
            "Data": {
                "Policy": {
                    "OriginalPolicyRef": "21010000H27250000020",  # 原保单号
                    "AgencyPolicyRef": co.RandomStr().create(),  # 第三方订单号
                    "PlanCode": "AS202412270102",  # 计划代码 续保计划码(年:AS202412270101、月:AS202412270102)
                ...
                "InsuredList": [
                    {
                        ...
                        "IdNumber": "130404198106151863",  # 证件号
                ...
                "InstallmentList": [
                    {
                        ...
                        "InstallmentPremium": "80.18",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "80.18"  # 分期保费
                    }
                ]
            },
