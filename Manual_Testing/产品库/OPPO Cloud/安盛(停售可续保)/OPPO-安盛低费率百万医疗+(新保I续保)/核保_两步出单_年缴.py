        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "PlanCode": "AS20230216040101",  # 计划代码;(尊贵款+特械:AS20230216040201,尊贵基础款:AS20230216040101)
                ...
                "PolicyHolder": {  # 投保人信息
                    ...
                    "PHIdNumber": "220421199206113904",  # 证件号/企业编号
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "220421195910215105",  # 证件号/企业编号
                        "BirthDate": "19591021000000",  # 出生日期 投保类型为2非必传
