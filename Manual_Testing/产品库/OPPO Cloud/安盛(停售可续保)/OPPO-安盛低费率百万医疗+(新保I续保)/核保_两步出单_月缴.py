                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "130404198106151863",  # 证件号/企业编号
                        "BirthDate": "19810615000000",  # 出生日期 投保类型为2非必传
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "79.31",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "79.31"  # 分期保费
                    }
                ]
            },
