...
class Renew_insurance:
    ...
    def Renew_insurance(self):
        ...
        body = {
            "Data": {
                "Policy": {
                    "OriginalPolicyRef": "21010000H27250000017",  # 原保单号
                    "AgencyPolicyRef": co.RandomStr().create(),  # 第三方订单号
                    "PlanCode": "AS202412270201",  # 计划代码 续保计划码(年:AS202302160201、月:AS202302160202)
                    "IssueDate": "20250104000000",  # 出单时间
                    "EffectiveDate": "20250104000000",  # 生效时间
                    "ExpireDate": "20260103235959",  # 失效时间
                    "GroupSize": "1",  # 被保人个数
                    "Currency": "CNY",  # 币种
                    "PaymentType": "1",  # 缴费方式：1-年缴2-月缴3-趸缴4-免缴
                    "TotalPremium": "3591.00",  # 总保费
                ...
                "PolicyHolder": {
                    ...
                    "PolicyHolderName": "于莲世",  # 用户姓名
                    "PHIdType": "01",
                    # 证件类型01居民身份证,02户口簿,03护照,04军官证,05驾驶执照,06港澳返乡证,07台胞证,08出生证,09统一社会信用代码,10纳税人识别号,11其他) 特殊说明下必传
                    "PHIdNumber": "110101197303079633",  # 证件号
                    "PHBirthDate": "19730307000000",  # 出生日期
                ...
                "InsuredList": [
                    {
                        ...
                        "IdNumber": "220421195910215105",  # 证件号
                        "BirthDate": "19591021000000",  # 出生日期
