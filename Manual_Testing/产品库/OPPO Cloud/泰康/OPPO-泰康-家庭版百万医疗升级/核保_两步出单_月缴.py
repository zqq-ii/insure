        ...
        body = {
            "Data": {
                ...
                "PolicyHolder": {  # 投保人信息
                    ...
                    "PHIdNumber": "610631199801079268",  # 证件号/企业编号
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "513436199801079487",  # 证件号/企业编号
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "54.20",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "54.20"  # 分期保费
                    }
                ]
            },
