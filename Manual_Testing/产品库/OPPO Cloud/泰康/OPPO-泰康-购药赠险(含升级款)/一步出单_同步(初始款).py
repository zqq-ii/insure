...
from Manual_Testing.common.communal import RandomStr, newIdNum, Execution_Time, Tomorrow, Birthday, Mailbox, \
    SeveralDays, Time, Logger
        ...
        body = {
            "Data": {
                "Policy": {
                    ...
                    "ExpireDate": SeveralDays(day=60),  # 失效时间
                    "GroupSize": "1",  # 被保人个数
                    "TotalPremium": "0",  # 总保费
                    "Currency": "CNY",  # 币别
