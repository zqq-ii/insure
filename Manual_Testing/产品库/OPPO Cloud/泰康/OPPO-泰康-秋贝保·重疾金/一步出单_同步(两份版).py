...
from Manual_Testing.common.communal import RandomStr, newIdNum, Mobilephone, Execution_Time, Tomorrow, SeveralYears, \
    Birthday, Nickname, Mailbox, Time, Logger
        ...
        body = {
            "Data": {
                ...
                "PolicyHolder": {
                    ...
                    "PHBirthDate": Birthday("210111199801078778"),  # 出生日期 （投保人类型为2-企业时非必填）
                    "PHEmail": Mailbox(),  # 邮箱
                    "PHAddress": "深圳市",  # 详细地址
                ...
                "InsuredList": [
                    {
                        ...
                        "Mobile": None,  # 手机号
                        "BirthDate": Birthday("210111199801078778"),  # 出生日期
                        "Email": Mailbox(),  # 邮箱
