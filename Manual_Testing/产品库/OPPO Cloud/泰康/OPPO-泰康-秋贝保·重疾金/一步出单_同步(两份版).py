...
from Manual_Testing.common.RandomNumber import RandomStr, newIdNum, Mobilephone, Execution_Time, Tomorrow, SeveralYears, Birthday, \
    Nickname, Mailbox,Time
        ...
        body = {
            "Data": {
                ...
                "PolicyHolder": {
                    ...
                    "PHIdNumber": "500238199801071896",  # 证件号
                    "PHTelephone": Mobilephone(),  # 手机号（投保人类型为2-企业时非必填）
                    "PHBirthDate": Birthday("500238199801071896"),  # 出生日期 （投保人类型为2-企业时非必填）
                    "PHEmail": Mailbox(),  # 邮箱
                    "PHAddress": "深圳市",  # 详细地址
                ...
                "InsuredList": [
                    {
                        ...
                        "IdType": "01",
                        # 证件类型01身份证,02户口簿,03护照,04军官证,05驾驶执照,06港澳返乡证,07台胞证,08出生证,09统一社会信用代码,10纳税人识别号,11其他)
                        "IdNumber": "500238199801071896",  # 证件号
                        "Mobile": None,  # 手机号
                        "BirthDate": Birthday("500238199801071896"),  # 出生日期
                        "Email": Mailbox(),  # 邮箱
