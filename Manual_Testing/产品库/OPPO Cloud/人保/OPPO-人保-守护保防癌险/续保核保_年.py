...
class Renew_insurance:
    ...
    def Renew_insurance(self):
        ...
        body = {
            "Data": {
                "Policy": {
                    "OriginalPolicyRef": "PWCB20244403Q000E01038",  # 原保单号
                ...
                "InsuredList": [
                    {
                        ...
                        "IdNumber": "35050319980107485X",  # 证件号
