...
class Joint_Investment:
    ...
    def Joint_Investment(self):
        ...
        body = {
            "Data": {
                "IsPermutation": False,  # 是否组合投保;默认为true,可不传,
                "PoliciesCommon":
                    {
                        "AgencyPolicyRef": RandomZ,  # 第三方订单号
                        "TotalPremium": "430.00",  # 总保费
                        "Currency": "CNY",  # 币别
                        "PaymentType": "1",  # 缴费方式：1-年缴2-月缴3-趸缴4-免缴
                        "TotalFaceAmount": "2000000.00",  # 总保额
                        "PlanCodeList": ["TP2023051102"]  # 组合投保的计划码列表，可以是一个或者多个 如 [10001,10002]
                    },
                "PolicyInfoList":
                    [
                        # {
                            ...
                            "SubjectMatterInsured":
                                {
                                    "SubjectMatterInsuredName": "欧珀官方旗舰店前海分店",  # 门店名称
                                    "SubjectMatterInsuredAddress": "广东省深圳市南山区前海卓越T1-L02",  # 门店地址
                                    "FaceAmount": 800,  # 标的保额 ，单位 元
                                    "StoreArea": 2,  # 门店面积 1：0-150平米，2：150-300平米
                                    "Province": "广东省",  # 省份
                                    "City": "深圳市",  # 市
                                    "District": "南山区"  # 区
                                }
